...
abstract class AbstractPluginFuncTest extends Specification {
    ...
    String baseBuildScriptWithoutPlugin() {
        baseBuildScript() - "id 'com.benrhine.one-test-plugin-to-rule-them-all-groovy'"
    }

    String baseBuildScriptWithNotAppliedTestRetryPlugin() {
        baseBuildScript().replace("id 'com.benrhine.one-test-plugin-to-rule-them-all-groovy'", "id 'com.benrhine.one-test-plugin-to-rule-them-all-groovy' apply false")
    }
