...
class StandardParallelThemeSpec extends BaseThemeSpec {
    ...
    def "after test with result type failure and showExceptions true"() {
        ...
        then:
            actual ==
                """|[erase-ahead,bold]com.benrhine.plugins.v1.internal.theme.StandardParallelThemeSpec[bold-off] floppy test[red] FAILED[red]
                   |
                   |  java.lang.AssertionError: This is wrong
                   |      at com.benrhine.plugins.v1.internal.theme.StandardParallelThemeSpec.getException(StandardParallelThemeSpec.groovy:${
                    LINE_NUMBER
                })
                   |[/]""".stripMargin().replace('\n', lineSeparator())
    }
