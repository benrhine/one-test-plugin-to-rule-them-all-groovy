...
class PlainParallelThemeSpec extends BaseThemeSpec {
    ...
    def "after test with result type failure and showExceptions true"() {
        ...
        then:
            actual ==
                """|com.benrhine.plugins.v1.internal.theme.PlainParallelThemeSpec floppy test FAILED
                   |
                   |  java.lang.AssertionError: This is wrong
                   |      at com.benrhine.plugins.v1.internal.theme.PlainParallelThemeSpec.getException(PlainParallelThemeSpec.groovy:${LINE_NUMBER})
                   |""".stripMargin().replace('\n', lineSeparator())
    }
