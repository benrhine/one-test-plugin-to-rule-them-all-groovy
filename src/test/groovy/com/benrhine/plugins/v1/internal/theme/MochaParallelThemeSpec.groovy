...
class MochaParallelThemeSpec extends BaseThemeSpec {
    ...
    def "after test with result type failure and showExceptions true"() {
        ...
        then:
            actual ==
                """|  [erase-ahead,default]com.benrhine.plugins.v1.internal.theme.MochaParallelThemeSpec [red]✘ floppy test[red]
                   |
                   |    java.lang.AssertionError: This is wrong
                   |        at com.benrhine.plugins.v1.internal.theme.MochaParallelThemeSpec.getException(MochaParallelThemeSpec.groovy:${LINE_NUMBER})
                   |[/]""".stripMargin().replace('\n', lineSeparator())
    }
