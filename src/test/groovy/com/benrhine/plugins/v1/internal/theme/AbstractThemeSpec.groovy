...
class AbstractThemeSpec extends BaseThemeSpec {
    ...
    private static Throwable lightenStackTrace(Throwable throwable) {
        throwable.stackTrace = throwable.stackTrace.findAll {
            it.className.contains 'benrhine'
        }
        ...
        then:
            actual ==
                """|
                   ...
                   |      at com.benrhine.plugins.v1.internal.theme.AbstractThemeSpec.generateException(AbstractThemeSpec.groovy:${LINE_NUMBER})
        ...
        then:
            actual ==
                """|
                   ...
                   |  java.lang.RuntimeException: Outer error
                   |      at com.benrhine.plugins.v1.internal.theme.AbstractThemeSpec.generateException(AbstractThemeSpec.groovy:${LINE_NUMBER})
                   |      at com.benrhine.plugins.v1.internal.theme.AbstractThemeSpec.<clinit>(AbstractThemeSpec.groovy:13)
                   |  Caused by: java.lang.RuntimeException: Middle error
                   |      at com.benrhine.plugins.v1.internal.theme.AbstractThemeSpec\$1.three(AbstractThemeSpec.groovy:22)
                   |      at com.benrhine.plugins.v1.internal.theme.AbstractThemeSpec\$1.two(AbstractThemeSpec.groovy:19)
                   |      at com.benrhine.plugins.v1.internal.theme.AbstractThemeSpec\$1.one(AbstractThemeSpec.groovy:17)
                   |      at com.benrhine.plugins.v1.internal.theme.AbstractThemeSpec\$1\$one.call(Unknown Source)
                   |      ... 2 more
                   |  Caused by: java.lang.RuntimeException: Inner error
                   |      at com.benrhine.plugins.v1.internal.theme.AbstractThemeSpec\$1.three(AbstractThemeSpec.groovy:22)
                   |      ... 5 more
