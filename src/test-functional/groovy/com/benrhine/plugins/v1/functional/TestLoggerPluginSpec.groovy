...
//            lines.size() == 28
//            lines[0] == render('')
//            lines[1] == render('[erase-ahead,bold]com.benrhine.test.FirstSpec[/]')
//            lines[2] == render('')
...
//            lines[14] == render('')
//            lines[15] == render('[erase-ahead,bold]com.benrhine.test.SecondSpec[/]')
//            lines[16] == render('')
...
//                   |    |
//                   |    false
//                   |      at com.benrhine.test.SecondSpec.this test should fail(SecondSpec.groovy:41)
//                   |[/]'''.stripMargin())
...
//            lines.size() == 10
//            lines[0] == render('')
//            lines[1] == render('[erase-ahead,bold]com.benrhine.test.FirstTest[/]')
//            lines[2] == render('')
...
//                   |      at com.benrhine.test.FirstTest.thisTestShouldFail(FirstTest.java:21)
//                   |[/]'''.stripMargin())
...
//                   |      at com.benrhine.test.FirstTest.thisTestShouldFail(FirstTest.java:18)
//                   |[/]'''.stripMargin())
//            lines[9] == render('[erase-ahead,bold]  Test [bold-off]thisTestShouldPass()[green] PASSED[/]')
//        and:
//            result.task(":test").outcome == FAILED
...
//            lines.size() == 8
//            lines[0] == render('')
//            lines[1] == render('[erase-ahead,bold]com.benrhine.test.ParamTest[/]')
//            lines[2] == render('')
...
//            lines.size() == 16
//            lines[0] == render('')
//            lines[1] == render('[erase-ahead,bold]com.benrhine.test.NestedTest[/]')
//            lines[2] == render('')
...
//            lines.size() == 10
//            lines[0] == render('')
//            lines[1] == render('[erase-ahead,bold]com.benrhine.test.DeepNestedTest[/]')
//            lines[2] == render('')
...
//            lines[3] == render('')
//            lines[4] == render('[erase-ahead,bold]com.benrhine.test.DeepNestedTest[/]')
//            lines[5] == render('')
...
//            lines[2] == render('    DeepNestedTest.beforeAllDeepNestedTest[/]')
//            lines[3] == render('')
//            lines[4] == render('  [erase-ahead,default]com.benrhine.test.DeepNestedTest[/]')
//            lines[5] == render('')
...
//            lines.size() == 15
//            lines[0] == render('')
//            lines[1] == render('[erase-ahead,bold]com.benrhine.test.DeepNestedTest > NestedTestsetLevelOne[bold-off] nestedTestsetLevelOne()[green] PASSED[/]')
...
//            lines[7] == render('')
//            lines[8] == render('[erase-ahead,bold]com.benrhine.test.DeepNestedTest > NestedTestsetLevelOne > Nested test set level two[bold-off] nestedTestsetLevelTwo()[green] PASSED[/]')
//            lines[9] == render('[default]')
...
//            lines.size() == 15
//            lines[0] == render('')
//            lines[1] == render('[erase-ahead,bold]com.benrhine.test.WordSpecTest[/]')
//            lines[2] == render('')
...
//            lines.size() == 8
//            lines[0] == render('')
//            lines[1] == render('[erase-ahead,bold]com.benrhine.test.CalculatorSpec[/]')
//            lines[2] == render('')
...
//                   |      at com.benrhine.test.FirstTest.thisTestShouldFail(FirstTest.java:16)
//                   |[/]'''.stripMargin())
...
//            lines.size() == 4
//            lines[0] == render('')
//            lines[1] == render('[erase-ahead,bold]com.benrhine.test.SecondSpec[/]')
//            lines[2] == render('')
//            lines[3] == render('[erase-ahead,bold]  Test [bold-off]this test should pass[green] PASSED[/]')
//        and:
//            result.task(":test").outcome == SUCCESS
...
//            lines.size() == 4
//            lines[0] == render('')
//            lines[1] == render('[erase-ahead,bold]com.benrhine.test.SlowSpec[/]')
//            lines[2] == render('')
...
//            lines[4] == render('')
//            lines[5] == render('[erase-ahead,bold]com.benrhine.test.SingleSpec[/]')
//            lines[6] == render('')
...
//            lines[4] == render('')
//            lines[5] == render('[erase-ahead,bold]com.benrhine.test.FirstSpec[/]')
//            lines[6] == render('')
...
//            lines[5] == render('')
//            lines[6] == render('[erase-ahead,bold]com.benrhine.test.SecondSpec[/]')
//            lines[7] == render('')
...
//            lines[3] == render('[erase-ahead,bold]  Test [bold-off]this test should fail[red] FAILED[/]')
//            lines[4] == render('')
//            lines[5] == render('[erase-ahead,bold]com.benrhine.test.SecondSpec[/]')
//            lines[6] == render('')
...
//            def lines = getLoggerOutput(result.output).lines
//        then:
//        // TODO - I edited this test
//            lines.size() == 2
//            lines[0] == render('')
//            lines[1] == render('com.benrhine.test.SingleSpec this is a single test PASSED')
////            lines[2] == render('')
////            lines[3] == render('  Test this is a single test PASSED')
//        and:
//            result.task(':test').outcome == SUCCESS
