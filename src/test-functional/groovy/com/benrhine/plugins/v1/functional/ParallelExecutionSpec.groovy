...
//        and:
//            lines.size() == 20
//            lines[0] == render('com.benrhine.test.FiveSpec this is test four PASSED')
//            lines[1] == render('com.benrhine.test.FiveSpec this is test one PASSED')
//            lines[2] == render('com.benrhine.test.FiveSpec this is test three PASSED')
//            lines[3] == render('com.benrhine.test.FiveSpec this is test two PASSED')
//            lines[4] == render('com.benrhine.test.FourSpec this is test four PASSED')
//            lines[5] == render('com.benrhine.test.FourSpec this is test one PASSED')
//            lines[6] == render('com.benrhine.test.FourSpec this is test three PASSED')
//            lines[7] == render('com.benrhine.test.FourSpec this is test two PASSED')
//            lines[8] == render('com.benrhine.test.OneSpec this is test four PASSED')
//            lines[9] == render('com.benrhine.test.OneSpec this is test one PASSED')
//            lines[10] == render('com.benrhine.test.OneSpec this is test three PASSED')
//            lines[11] == render('com.benrhine.test.OneSpec this is test two PASSED')
//            lines[12] == render('com.benrhine.test.ThreeSpec this is test four PASSED')
//            lines[13] == render('com.benrhine.test.ThreeSpec this is test one PASSED')
//            lines[14] == render('com.benrhine.test.ThreeSpec this is test three PASSED')
//            lines[15] == render('com.benrhine.test.ThreeSpec this is test two PASSED')
//            lines[16] == render('com.benrhine.test.TwoSpec this is test four PASSED')
//            lines[17] == render('com.benrhine.test.TwoSpec this is test one PASSED')
//            lines[18] == render('com.benrhine.test.TwoSpec this is test three PASSED')
//            lines[19] == render('com.benrhine.test.TwoSpec this is test two PASSED')
//        and:
...
//        and:
//            lines.size() == 17
//            lines[0] == render('com.benrhine.test.SingleSpec this is a single test PASSED')
//            lines[1] == render('')
...
//        and:
//            lines.size() == 4
//            lines[0] == render('[erase-ahead,bold]com.benrhine.test.FirstSpec[bold-off] this test should be skipped[yellow] SKIPPED[/]')
//            lines[1] == render('[erase-ahead,bold]com.benrhine.test.FirstSpec[bold-off] this test should fail[red] FAILED[/]')
//            lines[2] == render('[erase-ahead,bold]com.benrhine.test.SecondSpec[bold-off] this test should be skipped[yellow] SKIPPED[/]')
//            lines[3] == render('[erase-ahead,bold]com.benrhine.test.SecondSpec[bold-off] this test should fail[red] FAILED[/]')
//        and:
//            summary[0] == render('')
...
//        and:
//            lines.size() == 2
//            lines[0] == render('[erase-ahead,bold]com.benrhine.test.FirstSpec[bold-off] this test should fail[red] FAILED[/]')
//            lines[1] == render('[erase-ahead,bold]com.benrhine.test.SecondSpec[bold-off] this test should fail[red] FAILED[/]')
//        and:
//            summary[0] == render('')
//            summary[1].startsWith render('[erase-ahead,bold,red]FAILURE: [default]Executed 6 tests in')
//            summary[1].endsWith render('(2 failed, 2 skipped)[/]')
...
//        and:
//            lines.size() == 27
//            lines[0] == render('[erase-ahead,bold]com.benrhine.test.FirstSpec[bold-off] this test should pass[green] PASSED[/]')
//            lines[1] == render('[default]')
//            lines[2] == render('  FirstSpec - stdout setupSpec')
//            lines[3] == render('  FirstSpec - stderr setupSpec[/]')
//            lines[4] == render('')
//            lines[5] == render('[erase-ahead,bold]com.benrhine.test.FirstSpec[bold-off] this test should fail[red] FAILED[red]')
//            lines[6..13].join('\n') == render(
//                '''|
...
//                   |    |
//                   |    false
//                   |      at com.benrhine.test.FirstSpec.this test should fail(FirstSpec.groovy:41)
//                   |[/]'''.stripMargin())
...
//            lines[21] == render('')
//            lines[22] == render('[erase-ahead,bold]com.benrhine.test.FirstSpec[bold-off] this test should be skipped[yellow] SKIPPED[/]')
...
//                   |      at com.benrhine.test.FirstSpec.this test should fail(FirstSpec.groovy:41)
//                   |[/]'''.stripMargin())
//            lines[14] == render('[erase-ahead,bold]com.benrhine.test.FirstSpec[bold-off] this test should be skipped[yellow] SKIPPED[/]')
